...
if ($hasAccess) {
    ...
    Write-ColorOutput "   Run: .\fix_keyvault_permissions.ps1 -KeyVault $KeyVaultName" $Blue
}

Write-ColorOutput ""
Write-ColorOutput "Next Steps:" $Yellow
Write-ColorOutput "  1. Test database connection: .\diagnose_database_connectivity.ps1 -SqlServerName $SqlServerName" $Blue
