...
1. **Run Setup Script**
   ...
   ```
   This script configures environment variables, sets up network configuration, prepares all services, and handles data pipeline setup (Phase 3.5).
   
   **Data Pipeline Setup (Phase 3.5):**
   - The script automatically checks if market data exists
